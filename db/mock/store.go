...
// Source: github.com/julkar-naim/simple-bank/db/sqlc (interfaces: Store)
//
...
func (m *MockStore) GetAccountEntries(ctx context.Context, accountID int64) ([]db.Entry, error) {
	m.ctrl.T.Helper()
